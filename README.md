...
6. Use the command "git status" to see what happens with new files, you will notice it says that _HelloWorld.java_ is not being tracked.
...
10. Make an edit to the story.txt file on the git website interface. There should be this one commit from the web interface, but no more. **_You will AVOID🔥 using this manner of editing your work in the future_**.
